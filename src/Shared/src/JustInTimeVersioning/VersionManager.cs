...
using MSBLog = Microsoft.Build.Utilities.TaskLoggingHelper;
...
public class VersionManager : IDisposable
{
    ...
    public virtual void SaveVersions()
    {
        ...
        File.WriteAllText(VersionsJsonFilePath, Serialize(sortedVersions));
	...
	private IDictionary<string, string> InitializeVersionsDictionary()
	{
		...
		return Deserialize<Dictionary<string, string>>(
